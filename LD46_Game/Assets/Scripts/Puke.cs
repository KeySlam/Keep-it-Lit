...
public class Puke : Interactable
{
	[SerializeField]
	private InteractableIcon cleanupIcon = null;

	[SerializeField]
	private SpriteRenderer animator = null;
	...
	public class InteractionCleanup : Interaction
	{
		...
		public InteractionCleanup(Puke toilet, InteractableIcon icon, bool active = true) : base(icon, active)
		{
			this.toilet = toilet;
		}
